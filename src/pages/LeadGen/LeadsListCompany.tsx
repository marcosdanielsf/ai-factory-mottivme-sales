...
export const LeadsListCompany: React.FC = () => {
  ...
  const filteredLeads = useMemo(() => {
    ...
    return result;
  }, [leads, searchTerm, sortField, sortDir]);
          ...
          <div className="bg-bg-secondary border border-border-default rounded-lg p-4">
            <div className="flex items-center gap-3">
              <div className="relative flex-1 max-w-sm">
                ...
                <input
                  type="text"
                  placeholder="Buscar empresa, email ou URL..."
                  value={searchTerm}
              ...
              <button className="flex items-center gap-2 px-3 py-2 bg-bg-primary border border-border-default rounded-lg text-sm text-text-muted hover:text-text-primary hover:border-accent-primary/40 transition-all">
                <Filter size={14} />
                Filtros
              </button>
            </div>
          ...
          {loading ? (
            ...
            <div className="bg-bg-secondary border border-border-default rounded-lg p-12 text-center">
              ...
              <p className="text-sm text-text-muted">
                {searchTerm ? 'Tente ajustar a busca.' : 'Importe empresas para comecar.'}
              </p>
            </div>
          ) : (
            <div className="bg-bg-secondary border border-border-default rounded-lg overflow-hidden">
                        ...
                        <td className="px-4 py-3 text-sm">
                          {lead.company_url ? (
                            ...
                            >
                              ...
                              {lead.company_url.replace(/^https?:\/\//, '').replace(/\/$/, '')}
                            </a>
                          ) : (
...
export default LeadsListCompany;
