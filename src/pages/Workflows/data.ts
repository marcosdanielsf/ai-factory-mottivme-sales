  ...
  // =============================================
  {
    ...
    subSectors: [
      ...
      },
      {
        ...
        items: [
          { id: 'jXNBnrFzGDgOGpDj', name: 'Assembly Line - Central (Orquestrador)', status: 'on', type: 'workflow', url: `${N8N_BASE}/jXNBnrFzGDgOGpDj`, description: 'Workflow principal: Webhook → chama Partes 1-6 sequencialmente → gera conteudo final (posts, reels, carrosseis, stories)', tags: ['assembly-line', 'core'] },
          { id: '3rLcjPNxGf5yZsKW', name: 'Assembly Line - Trigger', status: 'on', type: 'workflow', url: `${N8N_BASE}/3rLcjPNxGf5yZsKW`, tags: ['assembly-line'] },
          { id: 'ZrCFCmBnM829kwvi', name: 'Assembly Line - Parte 1 (Clone DNA)', status: 'on', type: 'workflow', url: `${N8N_BASE}/ZrCFCmBnM829kwvi`, description: 'Agentes 1-4: DNA Psicologico, Engenharia Reversa, Configurador Clone, System Prompt (18 nodes)', tags: ['assembly-line'] },
          { id: 'my9wflS66v5ImyaE', name: 'Assembly Line - Parte 2 (Identity + Avatar + Promise + Big Idea)', status: 'on', type: 'workflow', url: `${N8N_BASE}/my9wflS66v5ImyaE`, description: 'Agentes 5-9: Identity Mapper, Perplexity Research, Synthesis, Avatar Creator, Promise Generator, Big Idea Creator', tags: ['assembly-line'] },
          { id: 'FhwLxjkefgY0LoXp', name: 'Assembly Line - Parte 3 (Ofertas Hormozi)', status: 'on', type: 'workflow', url: `${N8N_BASE}/FhwLxjkefgY0LoXp`, description: 'Agentes 10-12: High Ticket Designer, Back End Designer, Front End Designer (framework $100M Offers)', tags: ['assembly-line'] },
          { id: 'YKa577P8r07d0g4w', name: 'Assembly Line - Parte 4 (Conteudo + Funil)', status: 'on', type: 'workflow', url: `${N8N_BASE}/YKa577P8r07d0g4w`, description: 'Agentes 13-16: Content Strategist, Creative Producer, Funnel Builder, Email Sequences', tags: ['assembly-line'] },
          { id: 'gT9TqxcW5h7xGD9v', name: 'Assembly Line - Parte 5 (Prompt Personalizado)', status: 'on', type: 'workflow', url: `${N8N_BASE}/gT9TqxcW5h7xGD9v`, description: 'Gerador de Prompt + System Message personalizados, validacao, score de completude', tags: ['assembly-line'] },
          { id: 'PtLnvQe9wqszUZV2', name: 'Assembly Line - Parte 6 (Trilha Editorial)', status: 'on', type: 'workflow', url: `${N8N_BASE}/PtLnvQe9wqszUZV2`, description: 'Gerador de Trilha Editorial semanal com validacao e formatacao', tags: ['assembly-line'] },
