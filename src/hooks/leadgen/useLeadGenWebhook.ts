...
const WEBHOOK_PATHS: Record<WebhookAction, string> = {
  ...
  apollo_leads: "/webhook/5990f096-b106-4fcd-8847-cf15d151a310",
  gmaps_leads: "/webhook/get-gmaps",
  linkedin_leads: "/webhook/ec11af9d-ed48-4e98-a65e-5968f7dbfc85",
};
  ...
  const triggerWebhook = useCallback(
    async (
      ...
      try {
        ...
        const message =
          err instanceof Error ? err.message : "Erro ao disparar webhook";
