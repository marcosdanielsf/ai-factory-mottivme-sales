...
export function useAiosAgents(
  ...
  const updateAgent = useCallback(async ({ id, ...input }: UpdateAgentInput): Promise<AiosAgent | null> => {
  ...
  return { data, loading, error, refetch: fetchAgents, createAgent, updateAgent, deleteAgent };
}
