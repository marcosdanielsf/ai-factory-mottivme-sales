...
import { DollarSign, Calculator, Phone, AlertTriangle, TrendingUp, TrendingDown } from 'lucide-react';
...
export function CostOverviewCards({
  ...
  const trend = totalCalls > 10 ? { direction: 'down' as const, value: 8.3 } : null;

  return (
    <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 ${className}`}>
      {/* Custo Total - USD + BRL */}
