...
export default async function handler(req: VercelRequest, res: VercelResponse) {
    ...
    try {
        const { locationId, limit, startAfter, query } = req.query;
        ...
        if (startAfter && typeof startAfter === 'string') params.append('startAfter', startAfter);
        ...
        // Chamar GHL API
        // Endpoint: /contacts/?locationId={id}&limit=100&startAfter={timestamp}
        const ghlRes = await fetch(`${GHL_BASE_URL}/contacts/?${queryString}`, {
            headers: {
