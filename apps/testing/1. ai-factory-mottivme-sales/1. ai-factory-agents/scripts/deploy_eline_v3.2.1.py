#!/usr/bin/env python3
"""
Deploy Dra. Eline Lobo v3.2.1 to Supabase
CORREÇÕES:
- Identidade realista: "time da Eline" ao invés de "ser a Eline"
- Cenário: "é você mesma?" / "é robô?"
...
def main():
    # Read prompt file
    prompt_path = os.path.join(os.path.dirname(__file__), '..', 'prompts', 'eline_v3.2.1.md')
    ...
    print("\n1. Deactivating current version (v3.2.0)...")
    ...
    print("\n" + "="*60)
    print("  DEPLOY v3.2.1 COMPLETE!")
    print("  CORREÇÕES:")
    print("  - Identidade: 'time da Eline' (não 'ser a Eline')")
    print("  - Cenário: 'é você mesma?' / 'é robô?'")
    print("  - Baseado em neurovendas (congruência + honestidade)")
    print("="*60)
