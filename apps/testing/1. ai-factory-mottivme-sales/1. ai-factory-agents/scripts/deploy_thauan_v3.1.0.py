#!/usr/bin/env python3
"""
Deploy Maya - Assistente Dr. Thauan Santos v3.1.0 to Supabase
CORREÇÕES:
- Anti-loop (não repetir mensagem idêntica)
- Anti-invenção (não dizer "equipe vai mandar")
- Tratamento de erro de ferramenta (escalar humano)
...
def main():
    # Read prompt file
    prompt_path = os.path.join(os.path.dirname(__file__), '..', 'prompts', 'thauan_v3.1.0.md')
    ...
    print("\n1. Deactivating current version (v3.0.0)...")
    ...
    payload = {
        ...
        "agent_name": "SDR - Dr. Thauan Santos",
        "version": "v3.1.0",
    ...
    print("\n" + "="*60)
    print("  DEPLOY v3.1.0 COMPLETE!")
    print("  CORREÇÕES:")
    print("  - Anti-loop (não repetir mensagem idêntica)")
    print("  - Anti-invenção (não dizer 'equipe vai mandar')")
    print("  - Tratamento de erro de ferramenta → escalar humano")
