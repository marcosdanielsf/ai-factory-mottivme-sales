#!/usr/bin/env python3
"""
Deploy Isabella - Atendimento Dra. Gabriella Rossmann v2.0.0 to Supabase
CORREÇÕES:
- Anti-alucinação (não inventar estatísticas/garantias)
- Max 1 pergunta por mensagem
- Coleta de dados obrigatória antes do PIX
...
# Location onde a v1.4.1 está ativa
LOCATION_ID = "xliub5H5pQ4QcDeKHc6F"

def main():
    # Read prompt file
    prompt_path = os.path.join(os.path.dirname(__file__), '..', 'prompts', 'gabriella_atendimento_v2.0.0.md')
    ...
    print("\n1. Deactivating current version (v1.4.1)...")
    ...
    print("\n" + "="*60)
    print("  DEPLOY v2.0.0 COMPLETE!")
    print("  CORREÇÕES:")
    print("  - Anti-alucinação (não inventar estatísticas/garantias)")
    print("  - Max 1 pergunta por mensagem")
    print("  - Fase 5: Coleta de dados obrigatória")
    print("  - Respostas padrão para 'garantia?' e 'estatísticas?'")
