#!/usr/bin/env python3
"""
Deploy Isabella Amare v8.0.0 to Supabase
MAJOR UPDATE: Garantia + Linguagem Sensorial
"""
...
def main():
    # Read prompt file
    prompt_path = os.path.join(os.path.dirname(__file__), '..', 'prompts', 'isabella_amare_v8.0.0.md')
    ...
    print("\n" + "="*60)
    print("  DEPLOY v8.0.0 COMPLETE! (MAJOR UPDATE)")
    print("  - Linguagem Sensorial")
    print("  - Protocolo de Garantia")
    print("  - Fechamento Suave")
    print("="*60)
