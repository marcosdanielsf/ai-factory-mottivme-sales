#!/usr/bin/env python3
"""
Deploy Dra. Eline Lobo v3.0.0 to Supabase
MAJOR UPDATE: Fix colega excessivo, pergunta dupla, coleta de dados
"""
...
def main():
    # Read prompt file
    prompt_path = os.path.join(os.path.dirname(__file__), '..', 'prompts', 'eline_lobo_v3.0.0.md')
    ...
    payload = {
        ...
        "agent_name": "Dra. Eline Lobo - HormoSafe",
        "version": "v3.0.0",
    ...
    print("\n" + "="*60)
    print("  DEPLOY v3.0.0 COMPLETE! (MAJOR UPDATE)")
    print("  CORREÇÕES:")
    print("  - 'colega' max 1x por conversa")
    print("  - Uma pergunta por vez")
    print("  - Coleta de dados obrigatória")
    print("  - Anti-patterns documentados")
    print("  - Checklist antes de responder")
    print("="*60)
