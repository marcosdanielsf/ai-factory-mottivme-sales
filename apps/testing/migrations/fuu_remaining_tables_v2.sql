-- ============================================
-- FUU - Tabelas Restantes V2 (CORRIGIDO)
-- Data: 2026-01-09
-- ============================================
...
-- ============================================
-- 7. FUNCAO - Agendar Follow-up (CORRIGIDA)
-- ============================================
...
DECLARE
    ...
    v_queue_id UUID;
BEGIN
    -- Busca max_attempts da cadencia (usando follow_up_type VARCHAR)
...
BEGIN
    RAISE NOTICE '====================================';
    RAISE NOTICE 'FUU Tabelas Restantes V2 criadas!';
    RAISE NOTICE '====================================';
