...
# Buscar estrutura completa de um registro para ver todos os campos
curl -s "${SUPABASE_URL}/rest/v1/agent_versions?id=eq.78880474-d050-4076-be9d-b4b13db441db&select=*" \
