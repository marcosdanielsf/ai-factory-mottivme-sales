...
curl -s "${SUPABASE_URL}/rest/v1/agent_versions?is_active=eq.true&select=id,location_id,agent_name,version,status,created_at&order=created_at.desc&limit=20" \
