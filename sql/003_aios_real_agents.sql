...
INSERT INTO aios_squads (id, name, description, strategy, metadata) VALUES
  ('a0000001-0000-0000-0000-000000000001', 'Team Diana - Atelie', 'Agentes do Atelie Diana Brasil (4 unidades EUA)', 'collaborative', '{"client": "diana_brasil", "location_count": 4}'),
  ('a0000002-0000-0000-0000-000000000002', 'Team Financeiros', 'Agentes financeiros (Fernanda, Milton, Marina)', 'collaborative', '{"client": "apex_pro_financial", "vertical": "financeiro"}'),
  ('a0000003-0000-0000-0000-000000000003', 'Team Saude', 'Agentes de saude (Alberto, Eline, Gabriella)', 'collaborative', '{"vertical": "saude"}'),
  ('a0000004-0000-0000-0000-000000000004', 'Team BPOSS', 'Agente Heloise - BPO Simplificado', 'collaborative', '{"client": "bposs"}'),
  ('a0000005-0000-0000-0000-000000000005', 'Team Marcos Social', 'Agente Marcos - Social Business', 'collaborative', '{"client": "marcos_social"}');
...
INSERT INTO aios_agents (id, name, persona, role, status, capabilities, config, squad_id, total_executions, total_cost, last_active_at) VALUES
  ...
  ('4ed5c420-4e99-4245-bfa5-e6238dadac95',
   ...
   'a0000001-0000-0000-0000-000000000001', 0, 0, NOW()),
  ...
  ('f21fb515-907a-4dd2-95a1-5092f59f57cb',
   ...
   'a0000004-0000-0000-0000-000000000004', 0, 0, NOW()),
  ...
  ('1f8bb37f-f1c0-4ada-b72b-17845b1e6877',
   ...
   'a0000003-0000-0000-0000-000000000003', 0, 0, NOW()),
  ...
  ('7f878446-aaaa-4bbb-cccc-dddddddddddd',
  ...
  ('6c549226-8cd2-440d-9e81-6c12f19819a6',
   ...
   'a0000002-0000-0000-0000-000000000002', 0, 0, NOW()),
  ...
  ('4b038b87-31eb-4f31-8cf0-d5b761d29db7',
   ...
   'a0000005-0000-0000-0000-000000000005', 0, 0, NOW()),
...
INSERT INTO aios_squad_members (squad_id, agent_id, role) VALUES
  -- Team Diana
  ('a0000001-0000-0000-0000-000000000001', '4ed5c420-4e99-4245-bfa5-e6238dadac95', 'lead'),
  ('a0000001-0000-0000-0000-000000000001', 'e64753dc-96d8-40e6-bbe0-4a905b7add01', 'member'),
  ('a0000001-0000-0000-0000-000000000001', '600520c6-25aa-4091-a3e0-1344643b4dcd', 'member'),
  -- Team Financeiros
  ('a0000002-0000-0000-0000-000000000002', '6c549226-8cd2-440d-9e81-6c12f19819a6', 'lead'),
  ('a0000002-0000-0000-0000-000000000002', 'b5437e3c-f53c-4780-ae21-d05e7d4a4b8e', 'member'),
  ('a0000002-0000-0000-0000-000000000002', '86b1255d-8a82-4219-9dcb-dcf3b6a58d17', 'member'),
  -- Team Saude
  ('a0000003-0000-0000-0000-000000000003', '1f8bb37f-f1c0-4ada-b72b-17845b1e6877', 'lead'),
  ('a0000003-0000-0000-0000-000000000003', '1e6cb46c-2dd1-4754-8dfc-014f801511e0', 'member'),
  ('a0000003-0000-0000-0000-000000000003', '7f878446-aaaa-4bbb-cccc-dddddddddddd', 'member'),
  ('a0000003-0000-0000-0000-000000000003', 'eb421a7d-ee91-4ea1-a8f7-f07426b2bf4c', 'member'),
  -- Team BPOSS
  ('a0000004-0000-0000-0000-000000000004', 'f21fb515-907a-4dd2-95a1-5092f59f57cb', 'lead'),
  -- Team Marcos Social
  ('a0000005-0000-0000-0000-000000000005', '4b038b87-31eb-4f31-8cf0-d5b761d29db7', 'lead');
...
INSERT INTO aios_cost_budgets (name, period, budget_amount, alert_threshold, squad_id, is_active) VALUES
  ...
  ('Budget Financeiros', 'monthly', 30.00, 85, 'a0000002-0000-0000-0000-000000000002', true),
  ('Budget Saude', 'monthly', 25.00, 85, 'a0000003-0000-0000-0000-000000000003', true),
  ('Budget Diana', 'monthly', 20.00, 80, 'a0000001-0000-0000-0000-000000000001', true);
